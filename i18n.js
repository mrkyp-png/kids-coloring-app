...
(function () {
  ...
  var STRINGS = {
    en: {
      ...
      'mapScreen.backToCover': 'Back to title',
    ...
    ko: {
      ...
      'cover.startKids': '🎨 유아용 모드',
      'cover.startChallenge': '🎮 챌린지 모드',
      'mode.easy': '쉬움',
      'mode.normal': '보통',
      'mode.hard': '어려움',
      ...
      'mapScreen.backToCover': '표지로 돌아가기',
    ...
    ja: {
      ...
      'mapScreen.backToCover': 'タイトルにもどる',
    ...
    es: {
      ...
      'mapScreen.backToCover': 'Volver al inicio',
