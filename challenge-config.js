...
(function () {
  ...
  window.CHALLENGE_CONFIG = {
    ...
    LEVEL2_SWEEP_CYCLE_MS: 30000, // 2026-08-14 피드백: 30초 안에 지그재그로 전체 화면을 한 번 다 훑음 (문제 1~6번)
    LEVEL2_RANDOM_JUMP_MS: 900, // 2026-08-14 피드백: 문제 7~10번은 랜덤 점프로 전환, 점프 간격
    ...
    LEVEL9_INTERVAL_2: 2500, // 2026-08-14 피드백: 1초 -> 2.5초
    LEVEL9_INTERVAL_3: 2000, // 2026-08-14 피드백: 0.7초 -> 2초

    // ---- LEVEL 10, 명세서 15번: 색상 변경 주기(ms). 2026-08-14 피드백으로 문제 번호대별
    // 차등 적용(1~3번 5초, 4~6번 4초, 7~10번 3초) ----
    LEVEL10_INTERVAL_1: 5000,
    LEVEL10_INTERVAL_2: 4000,
    LEVEL10_INTERVAL_3: 3000,
  };
})();
